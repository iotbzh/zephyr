...
/*
 * vsp_regs.h  --  R-Car VSP Registers Definitions
 *
...
#ifndef __VSP_REGS_H__
#define __VSP_REGS_H__
...
#define VI6_DL_CTRL_DLE1		BIT(4)
#define VI6_DL_CTRL_CFM0		BIT(2)
#define VI6_DL_CTRL_NH0			BIT(1)
#define VI6_DL_CTRL_DLE0		BIT(0)
